    ...
    <Navbar/>
      ...
      <div id="contact" className='contact'>
        ...
        <div className='iconFlex'>
          <a href='https://twitter.com/cistLT' target="_blank" rel="noopener noreferrer"><img src={twitter} alt=''/></a>
          <a href="mailto:cist-lt@googlegroups.com"><img src={mail} alt=''/></a>
          <a href='https://github.com/cistLT-Club/' target="_blank" rel="noopener noreferrer"><img src={github} alt=''/></a>
        </div>
